...
export function HomePage() {
    ...
    return (
        <div className="space-y-8">
            {/* Hero Section */}
            <section className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg p-12 text-center shadow-sm">
                <h1 className="text-4xl font-bold mb-4">Welcome to AI Shopping Assistant</h1>
                <p className="text-xl mb-8">
                    Your intelligent companion for managing orders, getting recommendations, and comparing products
                </p>
                <div className="flex justify-center gap-4">
                    <a href="/orders" className="bg-white text-blue-700 px-6 py-3 rounded-lg font-semibold hover:bg-slate-100">
                        View Orders
                    </a>
                    <a href="/chat" className="bg-white text-blue-700 px-6 py-3 rounded-lg font-semibold hover:bg-slate-100">
                        Chat with AI
                    </a>
                </div>
            </section>
